...
export const TaskListNumber = () => {
  return (
    <div className='p-4 rounded-xl flex mt-10 justify-between gap-6 screen'>
      <div className='rounded-xl h-40 w-[40%] bg-red-300 rounded-xl flex flex-col items-center justify-center shadow-md'>
      ...
      <div className='rounded-xl h-40 w-[40%] bg-blue-300 rounded-xl flex flex-col items-center justify-center shadow-md'>
      ...
      <div className='rounded-xl h-40 w-[40%] bg-green-300 rounded-xl flex flex-col items-center justify-center shadow-md'>
      ...
      <div className='rounded-xl h-40 w-[40%] bg-yellow-300 rounded-xl flex flex-col items-center justify-center shadow-md'>
